...
$args = array(
	...
	'menu_title'                => esc_html__( 'Настройки сайта', 'your-textdomain-here' ),
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => 'Основыне настройки',
		'id'               => 'global-settings',
		'desc'             => 'Это основные настройки сайта',
...
Redux::set_section(
	...
	array(
		...
		'desc'             => 'Введите контактную информацию',
		'id'               => 'contact_info',
		'subsection'       => true,
		...
		'fields'           => array(
			array(
				...
				'type'     => 'textarea',
				'title'    => 'Адресс',
				'subtitle' => 'Введите юридический адресс компании',
				'desc'     => 'Будет отображаться на главной странице',
				'default'  => '',
			),
			array(
				'id'       => 'num_tel',
			...
			array(
				...
				'type'     => 'text',
				'title'    => 'Facebook',
				'subtitle' => 'Введите ссылку на Facebook',
				'desc'     => '',
				'default'  => '#',
			),
			array(
				...
				'type'     => 'text',
				'title'    => 'Instagramm',
				'subtitle' => 'Введите ссылку на Instagramm',
				'desc'     => '',
				'default'  => '#',
			),
			array(
				...
				'type'     => 'text',
				'title'    => 'Twitter',
				'subtitle' => 'Введите ссылку на Twitter',
				'desc'     => '',
				'default'  => '#',
			),
			array(
				...
				'type'     => 'text',
				'title'    => 'Вконтакте',
				'subtitle' => 'Введите ссылку на Вконтакте',
				'desc'     => '',
				'default'  => '#',
			),
			array(
				...
				'type'     => 'text',
				'title'    => 'Телеграм',
				'subtitle' => 'Введите ссылку на Telegram',
				'desc'     => '',
				'default'  => '#',
			),
			array(
				...
				'desc'     => '',
				'default'  => '© Lichnosty.ru 2024 Полное или частичное копирование материалов сайта разрешено только с указанием ссылки',
			),
			array(
				'id'       => 'copyright_small',
				'type'     => 'text',
				'title'    => 'Копирайт сайта (2 строка)',
				'subtitle' => 'Кипирайт для отображения в футере сайта во второй строке',
				'desc'     => '',
				'default'  => 'Полное или частичное копирование материалов сайта разрешено только с указанием ссылки',
			),
		),
	)
);
	...
	array(
		...
		'fields'           => array(
			array(
				'id'       => 'bio_button',
				'type'     => 'text',
				'title'    => 'URL страницы "Разместить биографию"',
				'subtitle' => 'Введите ссылку на страницу для формы размещения биографии',
				'desc'     => '',
				'default'  => '#',
			),
			array(
				'id'       => 'fback_button',
				'type'     => 'text',
				'title'    => 'URL страницы "Связаться с нами"',
				'subtitle' => 'Введите ссылку на страницу для формы обратной связи',
				'desc'     => '',
				'default'  => '#',
			),
		),
